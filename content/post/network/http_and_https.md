...
![](/images/6f6c5ed8-1262-4b44-83a0-c18902821752.png)访问百度流程

## http1.*和http2

![](/images/b609c812-112f-4e02-8dc1-db7301b03b56.png)

这个Akamai公司建立的一个官方的演示，使用HTTP/1.1和HTTP/2同时请求379张图片，观察请求的时间，明显看出HTTP/2性能占优势。

![](/images/cb0773c4-64c5-4f4a-9bdf-d9af8265f048.png)

多路复用：通过单一的HTTP/2连接请求发起多重的请求-响应消息，多个请求stream共享一个TCP连接，实现多流并行而不是依赖建立多个TCP连接。

HTTP报文格式

![](/images/abe7991d-7084-403b-91b6-85d9875e93ba.png)
...
![](/images/0165bba8-ae95-4577-9d6f-ce1ac4aa1224.png)博客登录抓包
...
![](/images/18415c33-f5e7-4033-8343-1e927b670f7b.png)
HTTPS数据传输流程
