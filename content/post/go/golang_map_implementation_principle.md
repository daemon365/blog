...
![](/images/bc444966-b890-4be6-b1d8-9d2596d5d4ec.png)
...
![](/images/ada04ce4-b4ec-4bb3-8add-e0d192f97184.png)
...
![](/images/f2be4f24-de4f-451a-a8d5-98b3f6b005af.png)
...
![](/images/a9cc075b-aa24-4fab-8eb4-1061f4264fca.png)
...
![](/images/56e139d0-b8ed-40e0-b096-5a3f7659f208.png)
...
![](/images/404e0490-65f9-40d2-be46-6ad3d207ca33.png)
...
![](/images/d8a63f0a-3592-4d2d-abbf-1d308dc24d1f.png)

扩容完成后，overflow bucket 消失了，key 都集中到了一个 bucket，更为紧凑了，提高了查找的效率。

![](/images/7bcdec53-7b75-42bc-8cc4-55511b02c758.png)

假设触发了 2 倍的扩容，那么扩容完成后，老 buckets 中的 key 分裂到了 2 个 新的 bucket。一个在 x part，一个在 y 的 part。依据是 hash 的 lowbits。新 map 中 `0-3` 称为 x part，`4-7` 称为 y part。

![](/images/307e9ec7-d7e0-4a77-b188-ce43cd8ec41a.png)
...
![](/images/275dddcd-9417-4ff2-bd86-1caa120df293.png)
...
![](/images/ad3e49ca-d762-496e-81ac-5795bf1b19b3.png)

这时，我们对此 map 进行遍历。假设经过初始化后，startBucket = 3，offset = 2。于是，遍历的起点将是 3 号 bucket 的 2 号 cell，下面这张图就是开始遍历时的状态：

![](/images/c26ab30d-161e-43d3-ab72-2420656e4cca.png)
...
![](/images/583ed90d-8021-419f-920b-fb26156a9403.png)
...
![](/images/c1e81445-397f-430c-86bb-dc62f261d074.png)
...
![](/images/02c7c564-1e6c-463c-a3c6-e60b0f631cc5.png)

和之前的流程一样，继续遍历新 1 号 bucket，发现老 1 号 bucket 已经搬迁，只用遍历新 1 号 bucket 中现有的元素就可以了。结果集变成：

![](/images/7de551d7-64c5-4c2f-8f54-73ac7c1c5e01.png)

继续遍历新 2 号 bucket，它来自老 0 号 bucket，因此需要在老 0 号 bucket 中那些会裂变到新 2 号 bucket 中的 key，也就是 `lowbit == 10` 的那些 key。

这样，遍历结果集变成：

![](/images/7369c973-b871-4903-b907-00a5a1d0a95a.png)
